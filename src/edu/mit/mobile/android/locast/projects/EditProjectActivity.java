...
public class EditProjectActivity extends Activity implements OnClickListener {
	static final String ACTION_ADD_CAST = "edu.mit.mobile.android.locast.ACTION_ADD_CAST",
						ACTION_TOGGLE_MEMBERSHIP = "edu.mit.mobile.android.locast.ACTION_TOGGLE_MEMBERSHIP",
						EXTRAS_CAST_URI = "edu.mit.mobile.android.locast.EXTRAS_CAST_URI";
