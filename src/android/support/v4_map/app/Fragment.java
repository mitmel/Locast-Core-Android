...
final class FragmentState implements Parcelable {
    ...
    public Fragment instantiate(MapFragmentActivity activity) {
        if (mInstance != null) {
            return mInstance;
        }
...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    MapFragmentActivity mImmediateActivity;
    ...
    public static Fragment instantiate(Context context, String fname, Bundle args) {
        try {
            ...
            final Fragment f = (Fragment)clazz.newInstance();
            if (args != null) {
     ...
     */
    final public MapFragmentActivity getActivity() {
        return mActivity;
    }
