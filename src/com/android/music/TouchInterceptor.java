 ...
 * Edited to be compatible w/ 1.6 (eg. no D&D color, getContext())
 */
...
public class TouchInterceptor extends ListView {
    ...
    public TouchInterceptor(Context context, AttributeSet attrs) {
        super(context, attrs);
        final SharedPreferences pref = context.getSharedPreferences("Music", 3);
        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    final View dragger = item.findViewById(R.id.icon);
                    final Rect r = mTempRect;
    ...
    private void startDragging(Bitmap bm, int y) {
        ...
        final int backGroundColor = getContext().getResources().getColor(R.color.darker_gray);
