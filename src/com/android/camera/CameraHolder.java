        ...
        if (mCameraDevice == null) {
            ...
            mParameters = mCameraDevice.getParameters();
            	...
            	try {
            		...
            		Method reconnect = mCameraDevice.getClass().getDeclaredMethod("reconnect");
            		reconnect.invoke(mCameraDevice);
            		
            	} catch(NoSuchMethodException ite){
            		Log.d(TAG, "no reconnect method");
	                ...
	                throw new CameraHardwareException(e.getCause());
				} 
